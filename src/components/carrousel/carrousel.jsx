            ...
            <Carousel.Item>
                ...
                <Carousel.Caption className='glass-effect'>
                    <div className='carrousel-content'>
                        ...
                        <p>
                            Explora tierras remotas, enfréntate a máquinas más grandes e imponentes
                            y descubre increíbles tribus en tu regreso a un futuro lejano en el
                            mundo apocalíptico de Horizon.
                        </p>
                    </div>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
                ...
                <Carousel.Caption className='glass-effect'>
                    <div className='carrousel-content'>
                        ...
                        <p>
                            Videojuego de acción y aventuras ambientado dentro del universo ideado
                            por George Lucas, concretamente entre los episodios tercero y cuarto de
